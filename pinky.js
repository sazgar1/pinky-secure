...
pinky.on('ready', () => {
  console.log(`Logged in as ${pinky.user.tag}!`);
 pinky.user.setActivity("p!help",{type: 'Playing'})
  console.log('')
  console.log('')
  console.log('╔[═════════════════════════════════════════════════════════════════]╗')
  ...
  console.log('')
  console.log('╔[════════════════════════════════════]╗');
  console.log(`Logged in as * [ " ${pinky.user.username} " ]`);
  console.log('')
  console.log('Informations :')
  console.log('')
  console.log(`server! [ " ${pinky.guilds.size} " ]`);
  console.log(`Users! [ " ${pinky.users.size} " ]`);
  console.log(`channels! [ " ${pinky.channels.size} " ]`);
  console.log('╚[════════════════════════════════════]╝')
  console.log('')
  console.log('╔[════════════]╗')
...
pinky.on("channelDelete", async channel => {
...
pinky.on("roleDelete", async channel => {
  const entry1 = await channel.guild
    .fetchAuditLogs({
      type: "ROLE_DELETE"
    })
...
pinky.on("roleCreate", async channel => {
  const entry1 = await channel.guild
    .fetchAuditLogs({
      type: "ROLE_CREATE"
    })
...
pinky.on("guildKickAdd", async (guild, user) => {
  const entry1 = await guild
    .fetchAuditLogs({
      type: "MEMBER_KICK"
    })
...
pinky.on("guildMemberRemove", async member => {
...
pinky.on("message", async message => {
...
pinky.on("guildMemberAdd", async member => {
